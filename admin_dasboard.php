    ...
    <div class="content" >
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="card-text"><strong>Wash & Fold:</strong> High-quality wash and fold service for your everyday laundry needs.</p>
                <p class="card-text"><strong>Dry Cleaning:</strong> Professional dry cleaning for your delicate and special garments.</p>
                <p class="card-text"><strong>Ironing:</strong> Crisp and perfect ironing to keep your clothes looking sharp.</p>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">About Us</h5>
                <p class="card-text">Luxury Laundry is committed to providing top-notch laundry services with a focus on quality and customer satisfaction. Our state-of-the-art facilities and experienced staff ensure that your clothes are treated with the utmost care.</p>
            </div>
        </div>
    </div>
    <div class="footer">
