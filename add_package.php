...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO service (nama_service, harga_jasa) VALUES (?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("si", $nama_service, $harga_jasa);

    if ($stmt->execute()) {
        echo "<script>alert('Service package added successfully');</script>";
    } else {
        echo "<script>alert('Error adding service package');</script>";
    }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="admin_dashboard.php" class="nav-link"><i class="fas fa-home"></i> Home</a>
    ...
    <div class="content">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                <label for="harga_jasa">Price</label>
